...
| 원격 Vision Gateway·배포 | `adr/0001-remote-vision-inference.md` → `D1_TECHNICAL_DECISIONS.md`의 D1-05 → `apps/kiosk/README.md` → Eye·Face Adapter 계약 → 승인 후 추가할 Vision Stream v1 |
